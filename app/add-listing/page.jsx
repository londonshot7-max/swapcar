...
export default function AddListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await supabase.from('listings').insert([{ ...form, user_id: user.id, year: parseInt(form.year), mileage: parseInt(form.mileage), price: parseFloat(form.price) }])
